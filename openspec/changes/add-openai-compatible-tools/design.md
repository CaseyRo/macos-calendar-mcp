...
- Consider adding pagination or result limits if needed in future
...
- Should we limit the number of search results? (Initial: return all matches, can add limits later if needed)
